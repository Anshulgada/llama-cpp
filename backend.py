...
class LLMBackend:
    ...
    def setup_rag_pipeline(self, stream_callback):
        try:
            ...
            template = """Use the following pieces of context to answer the question at the end. If you don't know the answer, just say that you don't know, don't try to make up an answer. Keep the answer as long or short as you like, there are no restrictions to the length. Provide answers using information stored in the vector store. If the answer to a question is known by you but not stored in the vector store, do not provide an answer. also always give source file name at end after answer to nextline.
            {context}
            Question: {question}
            Helpful Answer:"""
